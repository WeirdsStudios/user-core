...
/**
 * ¿La consulta es sobre soporte de ACTIIVA?
 *
 ...
 */
export function isOtherProductSupport(text: string): "ACTIIVA" | null {
  const t = normalize(text)
  const mentionsProduct = /\bactiiva\b/.test(t) ? "ACTIIVA" : null
